...
my_prog = Program(program_text)
edges = my_prog.edges
#[(0, 1), (0, 2), (1, 3), (2, 4), (3, 4), (4, 5), (5, 6), (5, 7), (6, 8), (7, 5)]
blocks = my_prog.blocks
#this is list of blocks for a program
#For getting the text corresponding to a block, do blocks[0].get_text(), 0 can be replaced by the index
